...
type AssignmentResponse struct {
	...
	AssignedVM     *SNAssignmentInfo             `json:"assigned_vm,omitempty"`
...
// SNAssignmentInfo represents information about an assigned VM
type SNAssignmentInfo struct {
...
// SNAssignmentResponse represents the response from assigning a VM to a group
type SNAssignmentResponse struct {
	Success     bool      `json:"success"`
	Message     string    `json:"message"`
	VMContextID string    `json:"vm_context_id"`
	GroupID     string    `json:"group_id"`
...
func (h *VMGroupAssignmentHandler) AssignVMToGroup(w http.ResponseWriter, r *http.Request) {
	...
	assignmentInfo := &SNAssignmentInfo{
		VMContextID: request.VMContextID,
