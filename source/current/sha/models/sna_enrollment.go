// Package models defines data structures for SNA enrollment system
package models
...
// SNAEnrollment represents a SNA enrollment request with approval workflow
type SNAEnrollment struct {
	ID             string     `json:"id" gorm:"primaryKey;column:id"`
	PairingCode    string     `json:"pairing_code" gorm:"column:pairing_code"`
	SNAPublicKey   string     `json:"vma_public_key" gorm:"column:vma_public_key"`
	SNAName        *string    `json:"vma_name" gorm:"column:vma_name"`
	SNAVersion     *string    `json:"vma_version" gorm:"column:vma_version"`
	SNAFingerprint *string    `json:"vma_fingerprint" gorm:"column:vma_fingerprint"`
	SNAIPAddress   *string    `json:"vma_ip_address" gorm:"column:vma_ip_address"`
...
func (SNAEnrollment) TableName() string {
	return "vma_enrollments"
}

// SNAConnectionAudit represents audit trail for SNA connection events
type SNAConnectionAudit struct {
	ID             int64     `json:"id" db:"id"`
	EnrollmentID   *string   `json:"enrollment_id" db:"enrollment_id"`
	EventType      string    `json:"event_type" db:"event_type"`
	SNAFingerprint *string   `json:"vma_fingerprint" db:"vma_fingerprint"`
...
// TableName specifies the table name for GORM
func (SNAConnectionAudit) TableName() string {
	return "vma_connection_audit"
}

// SNAActiveConnection represents an active SNA tunnel connection
type SNAActiveConnection struct {
...
// TableName specifies the table name for GORM
func (SNAActiveConnection) TableName() string {
	return "vma_active_connections"
}

// SNAPairingCode represents generated pairing codes for audit
type SNAPairingCode struct {
	ID                 string     `json:"id" gorm:"primaryKey;column:id"`
...
// TableName specifies the table name for GORM
func (SNAPairingCode) TableName() string {
	return "vma_pairing_codes"
}

// EnrollmentRequest represents the initial SNA enrollment request
type EnrollmentRequest struct {
	PairingCode    string `json:"pairing_code" binding:"required" example:"AX7K-PJ3F-TH2Q"`
	SNAPublicKey   string `json:"vma_public_key" binding:"required" example:"ssh-ed25519 AAAAC3NzaC1lZDI1NTE5..."`
	SNAName        string `json:"vma_name" example:"Production SNA 01"`
	SNAVersion     string `json:"vma_version" example:"v2.20.1"`
	SNAFingerprint string `json:"vma_fingerprint" example:"SHA256:abc123..."`
}
...
type AdminRejectionRequest struct {
	...
	Reason     string `json:"reason" binding:"required" example:"Unauthorized SNA enrollment attempt"`
}
