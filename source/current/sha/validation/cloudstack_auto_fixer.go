...
// Auto-detect SHA VM ID by searching for current VM
func (f *CloudStackAutoFixer) autoDetectOMAVM(ctx context.Context, config *CloudStackConfig) AutoFixResult {
	...
	return AutoFixResult{
		FixName:    "Auto-detect SHA VM",
		Attempted:  true,
		Successful: false,
		Message:    "Cannot auto-detect SHA VM ID",
		Details:    "SHA VM ID must be manually specified - check CloudStack for this VM's ID",
	}
}
