...
type OSSEAConfigRequest struct {
	...
	SHAVMID           string `json:"oma_vm_id" validate:"required" example:"8a4400e5-c92a-4bc4-8bff-4b6b0b6a018c"`
...
type OSSEAConfigResponse struct {
	...
	SHAVMID           string `json:"oma_vm_id" example:"8a4400e5-c92a-4bc4-8bff-4b6b0b6a018c"`
