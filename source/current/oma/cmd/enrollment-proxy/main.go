// Package main provides a port 443 proxy for VMA enrollment endpoints
// This allows NEW VMAs to reach enrollment API without existing tunnel
package main
...
var (
	...
	backend    = flag.String("backend", "http://localhost:8082", "Backend OMA API server")
...
func main() {
	...
	log.Printf("🔒 Starting VMA enrollment proxy on port %d", *port)
