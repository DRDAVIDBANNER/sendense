// Package services provides cryptographic operations for VMA enrollment system
package services
...
// VMACryptoService handles cryptographic operations for VMA enrollment
type VMACryptoService struct{}

// NewVMACryptoService creates a new VMA crypto service
func NewVMACryptoService() *VMACryptoService {
	return &VMACryptoService{}
}

// GenerateChallenge creates a cryptographically secure challenge nonce
func (vcs *VMACryptoService) GenerateChallenge() (string, error) {
...
// VerifySignature verifies Ed25519 signature of challenge using VMA's public key
func (vcs *VMACryptoService) VerifySignature(publicKeySSH string, challenge string, signatureB64 string) (bool, error) {
...
func (vcs *VMACryptoService) GenerateSSHFingerprint(publicKeySSH string) (string, error) {
...
func (vcs *VMACryptoService) parseSSHEd25519PublicKey(publicKeySSH string) (ed25519.PublicKey, error) {
...
// GetSSHHostKeyFingerprint retrieves the OMA server's SSH host key fingerprint
func (vcs *VMACryptoService) GetSSHHostKeyFingerprint() (string, error) {
...
func (vcs *VMACryptoService) ValidateSSHPublicKey(publicKeySSH string) error {
...
// GenerateKeyPair generates a new Ed25519 keypair (for VMA client use)
func (vcs *VMACryptoService) GenerateKeyPair() (ed25519.PublicKey, ed25519.PrivateKey, error) {
...
// SignChallenge signs a challenge with Ed25519 private key (for VMA client use)
func (vcs *VMACryptoService) SignChallenge(privateKey ed25519.PrivateKey, challenge string) (string, error) {
	// Decode challenge
	challengeBytes, err := base64.StdEncoding.DecodeString(challenge)
	if err != nil {
...
func (vcs *VMACryptoService) FormatSSHPublicKey(publicKey ed25519.PublicKey, comment string) string {
