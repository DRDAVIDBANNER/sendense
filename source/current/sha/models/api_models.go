...
// AuthRequest represents authentication request from SNA
...
// AuthResponse represents authentication response to SNA
...
// VMInventoryRequest represents VM inventory submission from SNA
...
// JobStatusRequest represents job status update from SNA
