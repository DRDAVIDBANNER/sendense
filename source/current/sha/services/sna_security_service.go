// Package services provides SNA enrollment security management
package services
...
// SNASecurityService handles security for internet-exposed enrollment
type SNASecurityService struct {
...
// NewVMASecurityService creates a new SNA security service
func NewVMASecurityService(
	db database.Connection,
	auditRepo *database.SNAAuditRepository,
) *SNASecurityService {
	return &SNASecurityService{
		db:        db,
		auditRepo: auditRepo,
		...
		emergencyKey: "EMERGENCY-SNA-BYPASS-2025", // Emergency bypass for legitimate access
	}
}

// ValidateSourceIP checks if source IP is allowed for enrollment
func (vss *SNASecurityService) ValidateSourceIP(ip string, config *SecurityConfig) (bool, string) {
...
func (vss *SNASecurityService) LogSecurityEvent(eventType string, ip string, details map[string]interface{}) {
...
func (vss *SNASecurityService) GetSecurityStatistics() (*SecurityStatistics, error) {
...
// ConfigurePort443Exposure configures SHA for secure port 443 exposure
func (vss *SNASecurityService) ConfigurePort443Exposure(config *SecurityConfig) error {
	log.WithFields(log.Fields{
...
func (vss *SNASecurityService) ValidateEmergencyBypass(bypassCode string) bool {
...
func (vss *SNASecurityService) MonitorSecurityThreats() {
