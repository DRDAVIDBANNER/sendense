...
// AtomicOMAResult represents the result of an atomic SHA database update
type Atomictype AtomicOMAResult struct {
...
// NewAtomicOMAService creates a new atomic SHA database service
