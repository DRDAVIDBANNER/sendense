...
type OSSEAConfig struct {
	...
	OMAVMID string `json:"oma_vm_id"` // The VM ID of this OMA appliance in OSSEA
...
type OSSEAVolume struct {
	...
	DevicePath string `json:"device_path"`                      // Mount path on OMA appliance
...
type ReplicationJob struct {
	...
	// VMA Progress Integration (v1.5.0)
	VMASyncType            string     `json:"vma_sync_type" gorm:"column:vma_sync_type"`
	VMACurrentPhase        string     `json:"vma_current_phase" gorm:"column:vma_current_phase"`
	VMAThroughputMBps      float64    `json:"vma_throughput_mbps" gorm:"column:vma_throughput_mbps;default:0.0"`
	VMAETASeconds          *int       `json:"vma_eta_seconds" gorm:"column:vma_eta_seconds"`
	VMALastPollAt          *time.Time `json:"vma_last_poll_at" gorm:"column:vma_last_poll_at"`
	VMAErrorClassification string     `json:"vma_error_classification" gorm:"column:vma_error_classification"`
	VMAErrorDetails        string     `json:"vma_error_details" gorm:"column:vma_error_details"`
...
// VolumeMount represents volume mount tracking on OMA appliance
