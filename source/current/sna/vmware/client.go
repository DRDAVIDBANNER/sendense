// Package vmware provides VMware client implementations for the SNA API
package vmware
...
// RealVMwareClient provides real VMware operations for the SNA API
type RealVMwareClient struct {
	service *Service
}

// NewRealVMwareClient creates a new real VMware client
func NewRealVMwareClient(shaClient *client.Client) *RealVMwareClient {
	return &RealVMwareClient{
		service: NewService(shaClient),
	}
}

// NewRealVMwareClientWithConfig creates a new real VMware client with custom configuration
func NewRealVMwareClientWithConfig(shaClient *client.Client, config ServiceConfig) *RealVMwareClient {
	return &RealVMwareClient{
		service: NewServiceWithConfig(shaClient, config),
	}
}
